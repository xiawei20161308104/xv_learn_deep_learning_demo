...
import warnings
import sys
sys.path.append("/sgc/microDL-master/microDL-master/micro_dl")
sys.path.append("/sgc/microDL-master/microDL-master/")
sys.path.append("/sgc/microDL-master/microDL-master/micro_dl/")
...
def parse_args():
    ...
    parser.add_argument(
        '--config',
        type=str,
        default='../config_preprocess_25D.yml',
    ...
    if 'tile' in preprocess_config:
        ...
        if 'weights' in preprocess_config:
            ...
            if 'mask_depth' in preprocess_config['tile']:
                weight_tile_config['depths'] = [
                    preprocess_config['tile']['mask_depth']]
            tile_dir = tile_images(
